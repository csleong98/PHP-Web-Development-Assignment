...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9">
                <h2 class="page-header">Saturn</h2>
                <div class="thumbnail">
                    <img class="img-responsive" src="WDTpictures/saturn.jpg" alt="">
                    <div class="caption-full">
                    <h4 class="pull-right">RM150 (per night)</h4>
                    <h4>
                        <a href="#">Saturn Room</a>
                    </h4>
                    <p>Deep dark blue and cozy.</p>
                    </div>
                </div>
            </div>
