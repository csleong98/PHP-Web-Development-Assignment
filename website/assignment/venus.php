...
$username = mysqli_escape_string($conn2,$_SESSION['user']);
...
$sql = SELECT * FROM rooms WHERE checkintime = '$cit';
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="caption-full">
                            ...
                            <p>See more snippets like these online store reviews at
                                <a target="_blank" href="http://bootsnipp.com">Bootsnipp - http://bootsnipp.com</a>.</p>
                ...
                <div class="col-md-3">
                    ...
                    <form class="form-vertical" action="venus.php" method="post">
                        <fieldset>
