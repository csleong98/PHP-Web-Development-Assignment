...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9">
                <h2 class="page-header">Moon</h2>
                <div class="thumbnail">
                    <img class="img-responsive" src="WDTpictures/moon.jpg" alt="">
                    <div class="caption-full">
                    <h4 class="pull-right">RM100 (per night)</h4>
                    <h4>
                        <a href="#">Moon Room</a>
                    </h4>
                    <p>A big step for mankind. And a moony step for you.</p>
                    </div>
                </div>
            </div>
