    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <img class="img-responsive" src="WDTpictures/jupiter.jpg" alt="">
                    <div class="caption-full">
                    <h4 class="pull-right">RM140 (per night)</h4>
                    <h4>
                        <a href="#">Jupiter Room</a>
                    </h4>
                    <p>Biggest room just like the biggest planets among the 9.</p>
                    </div>
                </div>
            </div>
