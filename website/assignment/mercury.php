    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <img class="img-responsive" src="WDTpictures/mercury.jpg" alt="">
                    <div class="caption-full">
                    <h4 class="pull-right">RM110 (per night)</h4>
                    <h4>
                        <a href="#">Mercury Room</a>
                    </h4>
                    <p>The mercury feel room that gives you the hotness of the Sahara and a bit of space</p>
                    </div>
                </div>
            </div>
