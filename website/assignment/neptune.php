...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9">
                <h2 class="page-header">Neptune</h2>
                <div class="thumbnail">
                    <img class="img-responsive" src="WDTpictures/neptune.jpg" alt="">
                    <div class="caption-full">
                    <h4 class="pull-right">RM130 (per night)</h4>
                    <h4>
                        <a href="#">Neptune Room</a>
                    </h4>
                    <p>The neptune feel room that gives you the feel of blue deep ocean that is surrounded by water.</p>
                    </div>
                </div>
            </div>
