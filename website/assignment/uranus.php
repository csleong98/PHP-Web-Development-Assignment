...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9">
                <h2 class="page-header">Uranus</h2>
                <div class="thumbnail">
                    <img class="img-responsive" src="WDTpictures/uranus.jpg" alt="">
                    <div class="caption-full">
                    <h4 class="pull-right">RM150 (per night)</h4>
                    <h4>
                        <a href="#">Uranus Room</a>
                    </h4>
                    <p>The uranus feel room that gives you the blue and icy ocean feel of the exact Uranus planet.</p>
                    </div>
                </div>
            </div>
